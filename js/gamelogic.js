...
export class GameLogic {
    ...
    restartPointerUpBinder;

    /**
     * 생성자
     */
    constructor(scene, camera, control, board, modelMgr, scoreMgr, soundMgr, gameTimer) {
    ...
    onPointerMove(event) {
        ...
        if( intersects && intersects.length > 0 && !this.isSpawning ) {
            ...
            const tile = pickObject.userData['linkedTile'];
            if( tile.level === 0 ) {
